...
3. Abra [http://localhost:3000](http://localhost:3000) — a primeira execução leva direto pro assistente de setup (`/setup`). Antes disso, siga o guia da [Wiki: Configuração do Google Cloud](https://github.com/andgabx/augmented-google-classroom/wiki/Google-Setup-PT) pra criar o projeto, ativar as APIs e gerar as credenciais OAuth (Client ID/Secret).
